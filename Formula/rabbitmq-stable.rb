class RabbitmqStable < Formula
  desc "Fixed version of Rabbit-mq (3.8.23) for lab development"
  homepage "https://github.com/OguchiLab/homebrew-tap"
  url "https://github.com/rabbitmq/rabbitmq-server/releases/download/v3.8.23/rabbitmq-server-generic-unix-3.8.23.tar.xz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "e2e39cecac6a49ec63cb38ec371ced99b83995b97315392772ccf1faaabb7a3c"
  end
